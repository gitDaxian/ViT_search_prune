...
class Attention(nn.Module):
    def __init__(self, dim, dim1, heads = 8, dim_head = 64, dropout = 0., qkv_bias = False):
        ...
        self.select = channel_selection(dim1)
...
class ViT_slim_cs(nn.Module):
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, cfg=None, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0., qkv_bias=False):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model_path = "../checkpoint/cifar10/advance/cifar10_pruned_attn0.0_ffn0.9.pth"
