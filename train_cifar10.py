...
# trainset = torchvision.datasets.CIFAR10(root='D:\DHU\CompressProject\DataSets', train=True, download=False, transform=transform_train)
trainset = torchvision.datasets.CIFAR10(root='/home/Datasets', train=True, download=False, transform=transform_train)

trainloader = torch.utils.data.DataLoader(trainset, batch_size=bs, shuffle=True, num_workers=0)

# testset = torchvision.datasets.CIFAR10(root='D:\DHU\CompressProject\DataSets', train=False, download=False, transform=transform_test)
testset = torchvision.datasets.CIFAR10(root='/home/Datasets', train=False, download=False, transform=transform_test)
