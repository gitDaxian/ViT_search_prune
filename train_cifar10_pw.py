...
from utils import set_gpu, seed_all, _pil_interp, load_partial_weight
...
if __name__ == '__main__':
    ...
    # data parameters
    parser.add_argument('--data_path', default='/home/Datasets', type=str, help='path to ImageNet data')
    parser.add_argument('--ckpt_path', default='./checkpoint/vit-pw-98.51.pth', type=str, help='path to load checkpoint')
    parser.add_argument('--batch_size', default=64, type=int, help='mini-batch size for data loader')
    parser.add_argument('--workers', default=0, type=int, help='number of workers for data loader')
    ...
    parser.add_argument('--save_per', default=1, type=int, help='save ckpt per epochs')
    ...
    for epoch in range(1, max_epoch+1):
        ...
        if val_acc > max_acc:
            max_acc = val_acc
            save_file = 'vit-pw4-' + str(round(max_acc, 2)) + '.pth'
